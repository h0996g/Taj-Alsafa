              ...
              children: [
                ...
                ElevatedButton(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: [
                              // A container for the multiline text field
                              Container(
                                height: 150,
                                width: double.infinity,
                                ...
                                child: TextField(
                                  ...
                                  // Use maxLines: null + expands for a flexible multiline field
                                  maxLines: null,
                                  expands: true,
                                ),
                              ),
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: appbar, // your desired background color
                    foregroundColor: Colors.black,
                    elevation: 2, // Adds a 3D effect
                    shape: RoundedRectangleBorder(), // Removes radius
                  ),
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Spacer(), // If you want spacing between text/icon
